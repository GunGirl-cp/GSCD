...
def main():
    ...
    mask_dir = '/home/hello/lpf/union_camera_mask'
    output_dir = '/home/hello/lpf/goodcamera'
    warp_output_dir = '/home/hello/lpf/warp_masks'
    ...
    for i in tqdm(range(len(image_files) - 1), desc="Processing images"):
        ...
        for homography_matrix, mask_path in homographies:
            warp_filename = f'{image_files[i].split(".")[0]}_from_{image_files[i+j].split(".")[0]}.png'
